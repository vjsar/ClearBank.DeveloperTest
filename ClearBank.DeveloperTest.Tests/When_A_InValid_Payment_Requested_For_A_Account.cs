...
{
    public class When_A_InValid_Payment_Requested_For_A_Account:Specification
    {
        ...
        public When_A_InValid_Payment_Requested_For_A_Account()
        {
        ...
        public void Result()
        {
            _makePaymentResult.Success.ShouldBeFalse("A Invalid Payment Requested For an Account");
        }
    }
}

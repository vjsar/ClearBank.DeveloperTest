...
{
    public class When_Validating_ChapsPaymentSchemeRule_With_Request_AccountStatus_Set_To_Live:Specification
    {
        ...
        public When_Validating_ChapsPaymentSchemeRule_With_Request_AccountStatus_Set_To_Live()
        {
        ...
        public void Result()
        {
            result.ShouldBeTrue("A Valid Account Status");
        }
    }
}

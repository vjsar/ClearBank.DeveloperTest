...
{
    public class When_Valdating_ChapsPaymentSchemeRule_With_Account_Balance_Equal_To_Request_Amount : Specification
    {
        ...
        public When_Valdating_ChapsPaymentSchemeRule_With_Account_Balance_Equal_To_Request_Amount()
        {

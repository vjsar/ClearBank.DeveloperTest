...
{
    public class When_Valdating_FasterPaymentSchemeRule_With_Account_Balance_Less_Than_Request_Amount:Specification
    {
        ...
        public When_Valdating_FasterPaymentSchemeRule_With_Account_Balance_Less_Than_Request_Amount()
        {
